...
const ReceiptGenerator: React.FC<ReceiptGeneratorProps> = ({ onBack }) => {
  ...
  return (
    ...
    >
      ...
      <button 
        onClick={onBack}
        className="absolute top-6 left-6 z-50 flex items-center gap-2 text-white/80 hover:text-white transition-colors bg-black/20 px-4 py-2 rounded-full backdrop-blur-md"
      >
        <ArrowLeft size={16} />
